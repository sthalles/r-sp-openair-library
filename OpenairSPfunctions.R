...
HySplit2Spdf <- function(traj, crs=NA)
{
  # Trasform a data.frame generated by the function ProcTraj in a Object of
  # type SpatialPointsDataFrame from the R's sp package 
  #
  # Args:
  #   traj: data.frame calculated by the ProcTraj function
  #   crs: The default projection for the SpatialPointsDataFrame object
  #
  # Results:
...
{
  # Converts a Data frame calculated by the function ProcTraj to a
  # SpatialLinesDataFrame Object
  #
  # Args:
  #   spLines: SpatialLines data frame Object
  #   df: data.frame Object. Typically calculated by the ProcTraj function
  #   crs: The default projection for the SpatialLinesDataFrame object
  #
  # Results:
  #   SpatialLinesDataFrame object   
...
{   
  # Convert a data frame calculated by the function ProcTraj to a SpatialLines 
  # Object
  #
  # Args:
  #
...
SplitSpLines <- function( sp.lines, into ) {
  ...
  if (size <= 1)
    stop("The length of the Spatial Lines object must be greater than 1 (one)")
